...
public class Motorista {
    ...
    private Motorista(String nome, int idade, int pontos, String habilitacao) {
        if(nome == null || habilitacao == null) throw new NullPointerException("nome e habilitacao sao obrigatorios");
        if(idade<18 || pontos >20) throw new EstacionamentoException("pontos ou idade insuficientes");
