...
public class Carro {
    ...
    private Carro(Motorista motorista, String placa, Cor cor) {
        if(cor == null||placa.isEmpty()) throw new NullPointerException("dados invalidos");
        if(motorista == null) throw new EstacionamentoException("deve haver um motorista no carro");
